...
function CategoriaPage() {
  const { solucao: s, categoria: c } = CategoriaRoute.useLoaderData() as {
    solucao: Solucao;
    categoria: Categoria;
  };
  useRolarAteTrilha(`${s.slug}/${c.slug}`);
    ...
    <PageTheme slug={s.slug}>
        ...
        <div className="wrap rhythm">
          <div className="p10-split">
            <div>
              ...
              {fin.subHero && (
                <p className="p10-lede" style={{ marginTop: 16 }}>
                  {fin.subHero}
                </p>
              )}
            </div>
      ...
      <section className="sec sec-dark">
        <div className="wrap">
          ...
          {valorPlacards ? (
            <>
              <h2 className="p10-h2" style={{ marginBottom: 4 }}>
                Uma decisão com mais controle
              </h2>
            ...
            <h2 className="p10-h2" style={{ maxWidth: "20ch" }}>
              {fin.valor}
            </h2>
          )}
          {fin.textoConsultivo && (
            <p className="p10-lede" style={{ marginTop: 18 }}>
              {fin.textoConsultivo}
            </p>
          )}
        </div>
