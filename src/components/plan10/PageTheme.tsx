...
.plan10-scope .prod-tile-name { flex: 1; text-wrap: balance; font-family: var(--fd); font-weight: 600; font-size: .98rem; line-height: 1.22; letter-spacing: -.01em; color: var(--preto); overflow-wrap: anywhere; }
