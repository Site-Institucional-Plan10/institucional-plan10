...
.plan10-scope .p10-form-add { align-self: flex-start; justify-self: start; background: none; border: none; padding: 2px 0; cursor: pointer; font-family: var(--fl); font-weight: 500; letter-spacing: .06em; text-transform: uppercase; font-size: .7rem; color: var(--va); }
